...
.button {
  ...
  &.icon-yes {
    ...
    .icon {
      background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="#{$color}"><path fill-rule="evenodd" clip-rule="evenodd" d="M98.58 45.806c.595-6.734-5.683-8.699-8.174-8.699-9.656-.002-19.315.001-28.972-.008 1.39-3.025 3.085-11.046.95-22.097-.843-4.369-3.421-7.275-6.705-7.217-2.646.046-5.173 2.086-5.438 4.63-.29 2.797-.977 6.78-1.627 9.504-2.128 8.911-13.738 20.762-20.734 24.504V45a3 3 0 0 0-3-3H4.38a3 3 0 0 0-3 3v43.667a3 3 0 0 0 3 3h20.5a3 3 0 0 0 3-3v-.261c4.907 2.917 10.252 3.912 15.969 3.803 8.732-.167 33.675-.021 38.195-.051 3.199-.021 6.389-1.547 7.923-5.409 2.096-5.271-3.307-7.908-3.307-7.908s5.915.292 7.267-5.014c1.387-5.446-4.055-7.601-4.055-7.601 3.68-.402 6.036-1.36 6.927-4.677 1.047-3.907-1.466-6.841-5.444-8.539.603-.059 6.679-1.04 7.225-7.204z"/></svg>');
    }
  }
